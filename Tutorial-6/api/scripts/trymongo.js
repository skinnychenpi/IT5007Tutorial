...
const url = 'mongodb://localhost/california';
...
function testWithCallbacks(callback) {
  ...
  client.connect(function(err, client) {
    ...
    const customer = { id: 1, name: 'Cristiano Ronaldo', phone: 92346275, time:'2021-10-21'};
...
async function testWithAsync() {
  ...
  try {
    ...
    const customer2 = [{id: 2, name: 'Leo Messi', phone: 12345678, time:'2021-10-23'},
    {id: 3, name: 'Neymar', phone: 92847372, time:'2021-10-23'}]
